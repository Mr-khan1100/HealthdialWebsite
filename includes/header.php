...
<head>
  ...
  <title><?php echo isset($pageTitle) ? $pageTitle . ' | HealthDial' : 'HealthDial - Find Medical Help Instantly'; ?>
  </title>
  <meta name="description"
    content="<?php echo isset($pageDesc) ? $pageDesc : 'Find Hospitals, Clinics, Labs & Doctors Near You – Instantly.'; ?>" />
...
<body>
  ...
  <nav class="navbar" id="navbar">
    <div class="container">
      ...
      <div class="nav-links">
        <a href="index.php" <?php if ($currentPage == 'home')
          echo 'class="active"'; ?>>Home</a>
        <a href="categories.php" <?php if ($currentPage == 'categories')
          echo 'class="active"'; ?>>Categories</a>
        <a href="listings.php" <?php if ($currentPage == 'listings')
          echo 'class="active"'; ?>>Listings</a>
        <a href="cities.php" <?php if ($currentPage == 'cities')
          echo 'class="active"'; ?>>Cities</a>
        <a href="blog.php" <?php if ($currentPage == 'blog')
          echo 'class="active"'; ?>>Blog</a>
        <a href="news.php" <?php if ($currentPage == 'news')
          echo 'class="active"'; ?>>News</a>
        <a href="contact.php" <?php if ($currentPage == 'contact')
          echo 'class="active"'; ?>>Contact</a>
        <a href="promote.php" <?php if ($currentPage == 'promote')
        ...
        <a href="download.php" class="btn btn-primary nav-cta"><i class="fas fa-download"></i> Get App</a>
      </div>
  ...
  <div class="mobile-nav">
    ...
    <a href="promote.php" style="color:#f59e0b;font-weight:600;"><i class="fas fa-bolt"></i> Promote Listing</a>
    <a href="download.php" class="btn btn-primary" style="margin-top:12px;"><i class="fas fa-download"></i> Download
      App</a>
  </div>
  ...
  <div class="mobile-bottom-nav" id="mobileBottomNav">
    ...
    <a href="listings.php" class="bottom-nav-item <?= $currentPage == 'listings' ? 'active' : '' ?>">
      <i class="fas fa-search"></i><span>Explore</span>
    </a>
    <a href="promote.php" class="bottom-nav-item <?= $currentPage == 'promote' ? 'active' : '' ?>" style="<?= $currentPage == 'promote' ? '' : 'color:#f59e0b;' ?>">
      <i class="fas fa-bolt"></i><span>Promote</span>
    </a>
    <a href="blog.php" class="bottom-nav-item <?= $currentPage == 'blog' ? 'active' : '' ?>">
      <i class="fas fa-heartbeat"></i><span>Health</span>
    </a>
    <a href="download.php" class="bottom-nav-item <?= $currentPage == 'download' ? 'active' : '' ?>">
