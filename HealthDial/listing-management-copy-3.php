...
/* CATEGORY */
if($category != ''){
    $sql .= " AND l.category_id = '".intval($category)."' ";
}
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <div class="flex space-x-4">
                            <a href="add-listing.php" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center">
                                <i class="fas fa-plus mr-2"></i> Add New Listing
                            </a>
                            <a href="bulk-upload.php" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center">
...
<?php echo htmlspecialchars($cat['name']); ?>
    ...
    <button type="submit" class="bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-900">Filter</button>
</form>
                                    ...
                                    <tr class="listing-row">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-sm">
                                            <div class="flex space-x-2">
                                                <a href="view-listing.php?view_id=<?php echo $row['id']; ?>" class="text-blue-600 hover:text-blue-900" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                
                                                <a href="update-listing.php?edit_id=<?php echo $row['id']; ?>" class="text-green-600 hover:text-green-900" title="Edit">
